...
public class manage_activitytype_fjava extends commontest_firefox {
  ...
  public void testActivitytype() throws Exception {
    ...
    driver.findElement(By.name("description")).sendKeys("Vounteer");
    driver.findElement(By.name("description")).clear();
    driver.findElement(By.name("description")).sendKeys("Volunteer");
    driver.findElement(By.name("description")).clear();
    driver.findElement(By.name("description")).sendKeys("Volunteer shares");
    driver.findElement(By.name("description")).clear();
    driver.findElement(By.name("description")).sendKeys("Volunteer shares experience");
    driver.findElement(By.name("description")).clear();
    driver.findElement(By.name("description")).sendKeys("Volunteer shares experience with someone");
    driver.findElement(By.name("description")).clear();
